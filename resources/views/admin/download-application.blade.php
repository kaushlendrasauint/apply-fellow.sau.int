    ...
    <div class="wrapper">
        ...
        <table style="width: 100%; border-collapse: collapse;" border="1">
            ...
            @endif
                ...
                <tr class="bg-color">
                    <td colspan="6"><h5>Legal Offences</h5></td>
                </tr>
                <tr>
                    <td colspan="6">     {!!  $application_form->legal_offences !!}</td>
                </tr>
                @endif

                @if($application_form->health_problems)
                <tr class="bg-color">
                    <td colspan="6"><h5>Health Problems</h5></td>
                </tr>
                <tr>
                    <td colspan="6">     {!!  $application_form->health_problems !!}</td>
                </tr>
                @endif

                @if($application_form->consider_lower_position)
                <tr class="bg-color">
                    <td colspan="6"><h5>Consider Lower Position</h5></td>
                </tr>
                <tr>
                    <td colspan="6">     {!!  $application_form->consider_lower_position !!}</td>
                </tr>
                @endif
